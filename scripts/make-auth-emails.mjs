...
<table role="presentation" width="560" cellpadding="0" cellspacing="0" style="max-width:560px;width:100%;background:#ffffff;border-radius:8px;overflow:hidden">
  <tr><td style="background:${GREEN};padding:22px 32px">
    <a href="${SITE}" style="text-decoration:none"><img src="${SITE}/brand/wordmark-white.png" width="230" height="34" alt="The Bookworm" style="display:block;border:0"></a>
    <div style="font-family:Helvetica,Arial,sans-serif;font-size:12px;color:#B7E4C7;margin-top:8px">Camarillo's independent bookstore since 1973</div>
  </td></tr>
