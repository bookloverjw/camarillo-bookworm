...
<table role="presentation" width="560" cellpadding="0" cellspacing="0" style="max-width:560px;width:100%;background:#ffffff;border-radius:8px;overflow:hidden">
  <tr><td style="background:${GREEN};padding:22px 32px">
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0"><tr>
      <td valign="middle"><a href="${SITE}" style="font-family:Georgia,serif;font-size:26px;font-weight:bold;color:#ffffff;text-decoration:none"><i style="font-weight:normal">The</i> Bookworm</a>
        <div style="font-family:Helvetica,Arial,sans-serif;font-size:12px;color:#B7E4C7;margin-top:3px">Camarillo's independent bookstore since 1973</div></td>
      <td valign="middle" align="right" width="100"><img src="${SITE}/brand/glasses-badge.png" width="96" height="54" alt="" style="display:block;border:0"></td>
    </tr></table>
  </td></tr>
  <tr><td style="padding:32px 32px 8px">
      <h1 style="margin:0 0 14px;font-family:Georgia,serif;font-size:24px;color:${GREEN}">${heading}</h1>
      ${body}
