...
<style>
  ...
  header { background: #1B4332; color: #fff; padding: .7in .75in .6in }
  ...
  .qr { width: 3.4in; height: 3.4in; padding: .22in; border: 3pt solid #1B4332; border-radius: .2in }
  ...
  <header><div class="kicker">Camarillo Bookworm · Since 1973</div><h1>Be first to hear</h1></header>
  <main>
